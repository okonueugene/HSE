<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme"
    ...
    <ul class="menu-inner py-1 ps">
        ...
        @if (auth()->user()->hasPermissionTo('view_sor'))
            <li
                class="menu-item {{ request()->routeIs(['sor', 'hazards', 'improvements', 'goodpractises', 'badpractises','open-sors']) ? 'active open' : '' }}">
                ...
                <ul class="menu-sub">
                    ...
                    @endif
                    <li class="menu-item {{ request()->routeIs('open-sors') ? 'active' : '' }}">
                        <a href="{{ route('open-sors') }}" class="menu-link">
        ...
        @if (auth()->user()->hasPermissionTo('view_incident'))
            ...
            <li
                class="menu-item {{ request()->routeIs(['incidents', 'nearmiss', 'medicaltreatedcase', 'losttimeaccidents', 'firstaidcase', 'sif', 'open-incidents']) ? 'active open' : '' }}">
                <a href="#" class="menu-link menu-toggle">
