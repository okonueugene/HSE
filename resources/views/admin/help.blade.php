                            ...
                            <div class="col-md-4 mb-md-0 mb-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        ...
                                        <a class="btn btn-sm btn-label-primary waves-effect"
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <li class="text-primary py-1">
                                                <a href="./pages-help-center-categories.html">Access to Admin
                                                    Account</a>
                                            </li>
                                            <li class="text-primary pb-1">
                                                <a href="./pages-help-center-categories.html">Send Email From an
                                                    Alias</a>
                                            </li>
                                        </ul>
                                        <p class="mb-0 fw-semibold">
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <li class="text-primary py-1">
                                                <a href="./pages-help-center-categories.html">Getting Started with the
                                                    App</a>
                                            </li>
                                            <li class="text-primary pb-1">
                                                <a href="./pages-help-center-categories.html">Getting Started with
                                                    Android</a>
                                            </li>
                                        </ul>
                                        <p class="mb-0 fw-semibold">
                            ...
                            <div class="col-md-4 mb-md-0 mb-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="mb-3">
                                            Expert tips and tools to improve your website or online store using our
                                            blog.
                                        </p>
                                        <a class="btn btn-sm btn-label-primary waves-effect"
                ...
                <div class="row justify-content-center py-5">
                    <div class="col-md-8 col-lg-6 text-center mt-4">
                        ...
                        <div class="d-flex justify-content-center flex-wrap gap-4">
                            <a href="javascript:void(0);" class="btn btn-primary waves-effect waves-light">Visit our
                                community</a>
                            <a href="javascript:void(0);" class="btn btn-primary waves-effect waves-light">Contact
                                us</a>
                        </div>
                    </div>
                </div>
