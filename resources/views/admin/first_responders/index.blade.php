    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="add-button ">
            <a href="#" class="btn btn-primary btn-sm float-end" data-bs-toggle="modal"
                data-bs-target="#addFirstResponderModal">Add
                First Responder</a>
        </div>
                ...
                <div class="modal-body" id="firstResponderDetails">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="firstResponderName"
                                    class="form-label
                                    fw-bold">Name</label>
                                <input type="text" class="form-control" id="firstResponderName" name="name" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="firstResponderDate" class="form-label fw-bold">Date</label>
                                <input type="text" class="form-control" id="firstResponderDate" name="date" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="firstResponderType" name="type" readonly>
                        </div>
                    </div>
                </div>
            </div>
