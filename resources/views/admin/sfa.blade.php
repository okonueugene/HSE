...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> </span>Stop Fix Actions</h4>
                ...
                <form class="add-new-record pt-0 row g-2 fv-plugins-bootstrap5 fv-plugins-framework"
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        ...
                        <div class="input-group input-group-merge has-validation">
                            ...
                            <input type="hidden" class="form-control dt-date flatpickr-input" id="basicDate"
                                name="basicDate" aria-describedby="basicDate2" placeholder="MM/DD/YYYY"
                                aria-label="MM/DD/YYYY" readonly="readonly"><input
                                class="form-control dt-date flatpickr-input flatpickr-mobile" tabindex="1"
                    ...
                    <div class="col-sm-12">
                        <button type="submit"
                            class="btn btn-primary data-submit me-sm-3 me-1 waves-effect waves-light">Submit</button>
