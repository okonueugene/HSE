...
<head>
    ...
    <title>Time & Attendance - HSE | Askari</title>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  />
                        ...
                        <span class="app-brand-text demo menu-text fw-bold">HSE</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="#" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Task Manager">Task Manager</div>
                        </a>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{route('incidents')}}" class="menu-link">
                                    <div data-i18n="View Incident">View Incident</div>
                                </a>
                            </li>
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="#" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Deviation">Deviation</div>
                        </a>

                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{route('deviations')}}" class="menu-link">
                                    <div data-i18n="View Deviations">View Deviations</div>
                                </a>
                            </li>
                            <!-- <li class="menu-item">
                    ...
                    <li class="menu-item active open">
                        <a href="{{route('attendance')}}" class="menu-link">
                            ...
                            <div data-i18n="Time & Attendance">Time & Attendance</div>
                        </a>
                    </li>
                            ...
                            <div class="card-datatable table-responsive pt-0">
                                <table class="datatables-basic table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <td>{{$row->time_in}}</td>
                                        <td>{{$row->time_out}}</td>
                                        <td>{{ round(abs(strtotime($row->time_out) - strtotime($row->time_in)) / 3600,2)}}</td>
                                        <td>
                                          <div class="dropdown">
