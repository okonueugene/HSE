                            ...
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top: 10px;">
                                    ...
                                    <select class="form-select"
                                        name="environmental_factors_included_in_risk_assessments"
                            ...
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top: 10px;">
                                    <label>Is electrical power for light and heat kept at a minimum
                                        period?</label>
                                    <select class="form-select"
                                        name="electrical_power_for_light_and_heat_kept_at_minimum"
                                    ...
                                    <select class="form-select" name="water_usage_minimized"
                                        id="water_usage_minimized">
                                        <option value="">Select</option>
                                        <option value="1">Yes</option>
                                        <option value="0">No</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top: 10px;">
                                    ...
                                    <select class="form-select"
                                        name="drip_trays_in_place_for_plant_and_fuelling_points"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top: 10px;">
                                    ...
                                    <select class="form-select" name="activities_smokeless"
                                        id="activities_smokeless">
                                        <option value="">Select</option>
                                        <option value="1">Yes</option>
                                        <option value="0">No</option>
                                    </select>
...
<script>
    ...
    $('#environmental-policy-checklist').on('submit', function(e) {
        ...
        axios.post('{{ route('environment-store-checklist') }}', formData)
            .then(response => {
